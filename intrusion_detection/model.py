...
FEATURE_ALIGNMENT_MAP = {
    ...
    'spkts': ['spkts', 'Tot Fwd Pkts', 'Total Fwd Packets', 'fwd_pkts', 'Fwd Packets', 
              'Fwd Pkts', 'Fwd Packets', 'Fwd Pkts/s', 'Tot Fwd Pkts'],
    'dpkts': ['dpkts', 'Tot Bwd Pkts', 'Total Bwd Packets', 'bwd_pkts', 'Bwd Packets', 
    ...
    'dbytes': ['dbytes', 'TotLen Bwd Pkts', 'Total Length of Bwd Packets', 'bwd_bytes', 
...
FEATURE_VARIATIONS = {
    ...
    'Tot Fwd Pkts': ['Tot Fwd Pkts', 'Total Fwd Packets', 'tot_fwd_pkts', ' Fwd Pkts', 
                     'Fwd Packets', 'fwd_pkts', 'spkts'],
    'Tot Bwd Pkts': ['Tot Bwd Pkts', 'Total Bwd Packets', 'tot_bwd_pkts', ' Bwd Pkts', 
    ...
    'TotLen Bwd Pkts': ['TotLen Bwd Pkts', 'Total Length of Bwd Packets', 'totlen_bwd_pkts', 
                        'Bwd Bytes', 'bwd_bytes', 'dbytes'],
    'Flow Byts/s': ['Flow Byts/s', 'Flow Bytes/s', 'flow_byts_per_sec', 'Bytes/s', 'rate'],
    'Fwd Pkt Len Mean': ['Fwd Pkt Len Mean', 'Fwd Packet Length Mean', 'fwd_pkt_len_mean', 
                         'Avg Fwd Segment Size', 'smean'],
    'Bwd Pkt Len Mean': ['Bwd Pkt Len Mean', 'Bwd Packet Length Mean', 'bwd_pkt_len_mean', 
                         'Avg Bwd Segment Size', 'dmean'],
    'Init Fwd Win Byts': ['Init Fwd Win Byts', 'Init Fwd Window Bytes', 'init_fwd_win_byts', 
                          'Fwd Window', 'swin'],
    'Init Bwd Win Byts': ['Init Bwd Win Byts', 'Init Bwd Window Bytes', 'init_bwd_win_byts', 
                          'Bwd Window', 'dwin'],
}
