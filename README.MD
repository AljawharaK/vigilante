...
A command-line tool for intrusion detection using Real-Valued Negative Selection (RNSA) + K-Nearest Neighbors (KNN).
...
# Running Interactive GUI as a website
vigilante interactive-gui --web
